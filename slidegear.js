 ...
 * version   : v0.1.6 — 20240502°2123 'Intermediate'
 * license   : GNU LGPL v3 or later (https://www.gnu.org/licenses/lgpl.html)
 * copyright : (c) 2019 - 2024 Norbert C. Maier (http://www.trilo.de)
 ...
 */
Sldgr.Cnst.info = {
   sVersion      : 'v0.1.6'                                            // [const 20190315°0543]
   , sTimestamp  : '20240502°2123'                                     // [const 20190315°0545]
};
...
Sldgr.Func.dSlide = function()
{
   ...
   // Path to the image [var 20190108°0141]
   // This is read from the user input array
   this.sImgPath = '';

   // Modify individual showing time [var 20190108°0143]
   // This is read from the user input array — not yet used
   this.nDurationFactor = 1.0;

   // Image text [var 20190108°0145]
   // This is read from the user input array
   this.sImgText = '';

   // The created page element [var 20190108°0147]
 ...
 * @param {number} iSliderId (Integer) — Slider ID
 */
Sldgr.Func.o1Slideshow = function( iSliderId )
{
   'use strict';

   // Syntax helper [var 20190106°1231]
   var oSelf = this;
   ...
   // User settings [var 20190106°1821]
   var oSt = {

      // Image list read from HTML attribute 'data-slidegear' [property 20190314°0636]
      aImgListFromAttrib : Array()

      // User setting [property 20190106°1241]
      , bAutostart : Sldgr.Cnst.bDefault_Autostart

      // User setting [property 20190323°0341]
      , bIsVisible01CaptionBox : false // false true

      // User setting [property 20190323°0443]
      , bIsVisible02NaviBox : false // true

      // User setting [property 20190323°0441]
      , bIsVisible03ToolsBox : false // true

      // User setting [property 20190106°1251]
      , bIsVisible04DebugBox : false // Sldgr.Cnst.bDefault_InfoPanelVisible

      // User setting [property 20190323°0545]
      , bIsVisibleDebugBorders : false // false true

      // User setting [property 20190106°1843]
      // todo : Not used yet, use it.
      , bRandomOrder : Sldgr.Cnst.bDefault_RandomOrder

      // User setting [property 20190106°1845]
      // todo : Not used yet, use it.
   ...
   var oVr = {
       ...
       */
       , Stage : {
         ...
         // Fading counter [prop 20190106°1847]
         iFadeCount : 0

         // Fading algorithm — not yet used [prop 20190106°1847]
         , iFadingAlgo : Sldgr.Cnst.CmdFade.Soft // Soft Hard

         // Index for current image in the stockpile array [prop 20190106°1851]
         , iNdxCurr : 0 // -1

         // The current movement mode [prop 20190108°0434]
         , iMode : Sldgr.Cnst.Mode.Single

         // Index for previous image in the stockpile array [prop 20190106°1853]
         , iNdxPrev : -1
      }
      ...
      // Slider panel height [prop 20190106°1721]
      ...
      // Image panel height [prop 20190106°1723]
      , iSliderPanelWidth : Sldgr.Vars.arDivSliders[iSliderId].clientWidth

      // This controls fading [prop 20190106°1411]
      ...
      // This controls sliding [prop 20190106°1412]
      , timerSlide : null
   };
   ...
   this.o1Slideshow_Code = function()
   {
      ...
      // todo : Test and fix
      if ( oSt.bRandomOrder ) {
         var iRand1 = Math.floor( Math.random() * oVr.aMgz.length ) ;
         for (var i2 = 0; i2 <= (iRand1 * oVr.aMgz.length) ; i2++ ) {
            aMgz.push(oVr.aMgz.shift());
         }
      }

      // Do random start [seq 20190106°1923]
      if ( oSt.bRandomStart ) {
         var iRand2 = Math.floor( Math.random() * oVr.aMgz.length ) ;
   ...
   this.o2ReadSetup = function()
   {
      ...
      // Read all keys [seq 20190107°0615] (not IE8 forEach)
   ...
   /**
    * This method shall populate the record array for this slider from either
    *  of the following • JSON file • HTML attribute • built-in fallback list
    *
    * @id 20190106°0615
   ...
   this.o2ReadSetup_ImageList = function()
   {
      ...
      // Pessimistic predetermination [seq 20190314°0627]
      ...
      if ( typeof oSt.aImgListFromAttrib !== 'undefined' ) {           // [mark 20210517°1111`zz] Undefined check
         if ( oSt.aImgListFromAttrib !== null ) {                      // [condi 20190314°0632]
            if ( oSt.aImgListFromAttrib.length > 0  ) {                // [condi 20190314°0633]
               ...
               // Provide list as below known variable [seq 20190314°0637]
      ...
      if ( oSt.sReadFromJson !== '' )
      {
         ...
         // New asynchronous reading [seq 20190418°0311]
         // Remember chg 20190418°0331 'all ajax asynchronous, no more synchronous'
         Trekta.Utils.readTextFile2 ( sFnam
                                     , this.o2ReadSetup_3_ImageListConti
                                      );
         // Leave a provisory setting until JSON is read [line 20190418°0313]
         bUseFallback = true;
      }
      // Use built-in fallback [seq 20190106°1521]
      else {
      ...
      // Load built-in fallback images [seq 20190106°1523]
      if ( bUseFallback ) {
         Sldgr.Vars.arImgImport = Sldgr.Cnst.aFallbackShow_One;
      }

      // Fill user input array into magazine [line 20190418°0323]
      oSelf.o2ReadSetup_4_fillMagazine();
   };

   /**
    * This method .. shall continue the Ajax reading from above ..
    *
    * @id 20190418°0211
    * @callers Only •
    * @param sJson {string} Content of the read JSON file
    */
   this.o2ReadSetup_3_ImageListConti = function(sJson)
   {
      'use strict';
      ...
      try {
         ...
         // The above fallback stays active
         // todo : Provide some feedback [todo 20190418°0316]
      }

      // Brute force try while chg 20190418°0331
      //  Fill user input array into magazine [line 20190418°0325]
      oSelf.o2ReadSetup_4_fillMagazine();

      // Rebuild the background div [line 20190418°0317]
      oSelf.o3Build0Html();

      // ~~Connect magazin with background div [line 20190418°0318]
      oSelf.o4FillMagazine();
   };

   /**
    * Fill flat user input image array into magazine
    *
    * @id 20190418°0321
    * @note Here the Magazine array is filled, except for fields slid.eSliDiv
    *        and slid.sSizeFactor, which can be filled only later.
    * @note Method created from outsourced sequence while brute force try
    *     while chg 20190418°0331 to enable double calling
    * @callers • func 20190106°0615 o2ReadSetup_ImageList
    *           • func 20190418°0211 o2ReadSetup_3_ImageListConti
    * @returns {void} —
    */
   this.o2ReadSetup_4_fillMagazine = function()
   {
      'use strict';

      // () Fill flat user input image array into magazine [seq 20190106°1525]
      oVr.aMgz = [];
   ...
   this.o3Build0Html = function()
   {
      ...
      for ( var i = 0; i < oVr.aMgz.length; i++ )
      {
         var eDiv = document.getElementById(oCs.sId_Div_Stock + i);
         oVr.aMgz[i].eSliDiv = eDiv;
      }
   };
   ...
   this.o3Build1ImgPanel = function()
   {
      ...
      for ( var iImg = 0; iImg < oVr.aMgz.length; iImg++ ) {
         ...
         // [seq 20190106°1623]
         sDiv += '<img src="' + oVr.aMgz[iImg].sImgPath + '"'
               + ' style="border:0;"'
   ...
   this.o3Build3NaviPanel = function()
   {
      ...
      var sFrg2 = '';
      for ( var iNum = 1; iNum <= oVr.aMgz.length; iNum++ ) {
   ...
   this.o3Build4ToolsPanel = function()
   {
      ...
      // Toolbox unfolder button [seq 20190323°0451]
      var sDv1 = '<div';
      ...
      // Toolbox close button [seq 20190314°0425]
      var sDv2 = '<div';
   ...
   this.o3Build51DebugPanel_2 = function()
   {
      ...
      // Iterate slides in magazine [seq 20190323°0145] (not IE8 forEach)
      oVr.aMgz.forEach( function( elCurr, iNdx, arr) {
   ...
   /*
   issue 20190418°0331 'something complicated with asynchronous slide loading'
   matter : While chg 20190418°0331 'all ajax asynchronous, no more synchronous'
      For filling the magazine in behind, there seem to be not enough
      sId_Div_Stock elements. Where are those built? In o3Build1ImgPanel.
   location : Func 20190106°1941 Sldgr.Func.o4FillMagazine
   status : ?
   */
    ...
    *
    * @id 20190106°1941
    * @see issue 20190418°0331 'something complicated with asynchronous slide loading'
    * @callers Only • startup
    */
   this.o4FillMagazine = function()
   {
      ...
      // Iterate the prepared magazine [seq 20190106°1943]
      for ( var iImg = 0; iImg < oVr.aMgz.length; iImg++ ) {
         // Fill in the page elements [seq 20190107°0341]
         var eDiv = document.getElementById(oCs.sId_Div_Stock + iImg);
         oVr.aMgz[iImg].eSliDiv = eDiv;
      }
   };
   ...
   this.oClickGoOneLeft = function()
   {
      ...
      oVr.Stage.iMode = Sldgr.Cnst.Mode.Single;
      oSelf.oUpdateButtons();
      var iGoto = (oVr.Stage.iNdxCurr < 1) ? oVr.aMgz.length - 1 : oVr.Stage.iNdxCurr - 1;
   ...
   this.oClickGoOneRight = function()
   {
      ...
      oVr.Stage.iMode = Sldgr.Cnst.Mode.Single;
      oSelf.oUpdateButtons();
      var iGoto = (oVr.Stage.iNdxCurr < oVr.aMgz.length) ? oVr.Stage.iNdxCurr + 1 : 0;
    ...
    *
    * @id 20190106°0741
    * @param {number} iNumSelected (Integer) — The number of the image to trigger
    */
   ...
   this.oClickUnfolderBtns = function(sButtonName)
   {
      ...
      // Successful experiment [line 20190315°0413]
   ...
   this.oSlideProject = function()
   {
      ...
      // Display caption before fading [line 20190422°0113]
      // Remember issue 20190422°0111 'first image caption is an empty quote'
      this.oUpdateImageCaption();

      // Calculate alpha [seq 20190106°2111]
      var nAlphaGrow = 1 - (1 / oSt.iFadingSteps * oVr.Stage.iFadeCount);
      var nAlphaWane = 1 - nAlphaGrow;

      // [seq 20190106°2021]
      oVr.aMgz[oVr.Stage.iNdxPrev].eSliDiv.style.zIndex = 1;
      oVr.aMgz[oVr.Stage.iNdxPrev].eSliDiv.style.visibility = 'visible'; // only while fading
      oVr.aMgz[oVr.Stage.iNdxPrev].eSliDiv.style.filter = 'Alpha(Opacity = ' + (nAlphaWane * 100) + ')';
      oVr.aMgz[oVr.Stage.iNdxPrev].eSliDiv.style.MozOpacity = nAlphaWane; // seems outdated
      oVr.aMgz[oVr.Stage.iNdxPrev].eSliDiv.style.opacity = nAlphaWane;

      oVr.aMgz[oVr.Stage.iNdxCurr].eSliDiv.style.zIndex = 2;
      oVr.aMgz[oVr.Stage.iNdxCurr].eSliDiv.style.visibility = 'visible';
      oVr.aMgz[oVr.Stage.iNdxCurr].eSliDiv.style.filter = 'Alpha(Opacity = ' + (nAlphaGrow * 100) + ')';
      oVr.aMgz[oVr.Stage.iNdxCurr].eSliDiv.style.MozOpacity = nAlphaGrow;
      oVr.aMgz[oVr.Stage.iNdxCurr].eSliDiv.style.opacity = nAlphaGrow;
    ...
    * @param {number} iNdxTarget (Integer) — Mostly null, otherwise explicit image request
    * @param {boolean} bGoHard — Debug helper flag
    */
   this.oSlideProjectNext = function(iNdxTarget, bGoHard)
   {
      ...
      if ( oVr.Stage.iNdxPrev !== null ) {
         oVr.aMgz[oVr.Stage.iNdxPrev].eSliDiv.style.visibility = 'hidden';
      }
      ...
      if ( oVr.Stage.iNdxCurr >= oVr.aMgz.length ) {
         oVr.Stage.iNdxCurr = 0;
      } else if ( oVr.Stage.iNdxCurr < 0 ) {
         oVr.Stage.iNdxCurr = oVr.aMgz.length - 1;
      }

      // Maintain image caption [line 20190106°2041]
      // Remember issue 20190422°0111 'very first image caption is an empty quote'
      // // this.oUpdateImageCaption();
    ...
    *  To see this output, open all GUI flaps
    *
    * @id 20190108°0511
   ...
   this.oSlideProject_Output = function()
   {
      ...
      if ( Sldgr.Vars.bDbgOut_6_slide_trigger ) {
         ...
         var s = 'trigger no ' + (oVr.Stage.iNdxCurr + 1) + ' (' + el.width + ' * ' + el.height + ')'
                + ' ' + oVr.aMgz[oVr.Stage.iNdxCurr].sImgPath
                 ;
      ...
      // Debug magazine [seq 20190323°0153] (not IE8 forEach)
      //  Analyse e.g. solved issue 20190312°0821 'misguided image'
      oVr.aMgz.forEach( function( elCurr, iNdx, arr) {
         // [line 20190108°0514]
         var sInfo = '' + (iNdx + 1)
   ...
   this.oUpdateBorders = function()
   {
      ...
      // Create array with borders [seq 20190323°0553]
      var aEls = Array();
      ...
      // Set border style [seq 20190323°0555] (not IE8 forEach)
      ...
      // Maintain button [seq 20190323°0557]
    ...
    *
    * @id 20190106°0911
    * @note : Remember issue 20190422°0111 'very first image caption is an empty quote'
   ...
   this.oUpdateImageCaption = function()
   {
      ...
      ele.innerHTML = "<small>(" + (oVr.Stage.iNdxCurr + 1) + "<small>/"
                     + oVr.aMgz.length + "</small>)</small> "
                      + oVr.aMgz[oVr.Stage.iNdxCurr].sImgText
                       ;
   };
 ...
 *
 * @id 20190106°1211
 * @summary This is a one-dimensional array with three fields for each image.
 *     There exists only one single of it, and it is processed before a
 ...
 * @type {string} —
 */
Sldgr.Cnst.sDefault_DummyImageOne = 'docs/imgs/20090504o2215.grainydummy180sq.v0.x0360y0360q66.jpg';
 ...
 * @type {string} —
 */
Sldgr.Cnst.sDefault_DummyImageThree = 'docs/imgs/20130304o1422.grainydummy480prt.v0.x0270y0360q66.jpg';
 ...
 * @type {string} —
 */
Sldgr.Cnst.sDefault_DummyImageTwo = 'docs/imgs/20130304o1421.grainydummy640ls.v0.x0360y0270q66.jpg';
 ...
 *  Version     : v0.2.9 — 20240428°1911
 *  Copyright   : © 2019 - 2024 Norbert C. Maier
 *  License     : GNU AGPL v3
 *  Content     : Overview on Trekta.Utils. objects
 *    • func 20110510°2127 — getCookie(sCookieName)
 *    • func 20120828°2021 — getCookieBool(sCookieName, bDefault)
 *    • func 20190420°0311 — getCookieInt(sCookieName, iDefault)
 *    • func 20110820°1741 — getFileNameFull()
 *    • func 20120827°1511 — getFilenamePlain()
 *    • func 20140926°1431 — htmlEscape(sHtml)
 *    • func 20160503°0231 — isScriptAlreadyLoaded(sWantedScript)
 *    • func 20150321°0311 — outDbgMsg(sOut)
 *    • func 20150323°0321 — outDbgMsg_GuaranteeParentElement()
 *    • func 20110821°0121 — pullScriptBehind(sScLoad, callbackOnLoad, callbackOnError, oJobs)
 *    • func 20190405°0341 — pullScript_onload(sScript, cbkCustom)
 *    • func 20190417°0311 — readTextFile2(sUrl, cbkLoad, cbkFail)
 *    • func 20190405°0231 — ajax3Send(sMethod, sUrl, sPayload, cbkLoad, cbkFail)
 *    • func 20110820°2041 — retrieveDafBaseFolderAbs(sScCanary)
 *    • func 20201203°1445 — sConfine(sOrig, iMaxLen)
 *    • func 20110510°2126 — setCookie(sCookieName, sCookieValue, iExpirationDays)
 *    • func 20160614°0331 — windowOnloadDaisychain(funczion)
 *    • var 20190405°0345 — aPulled = [];
 *    • var 20160622°0221 — bIs_Browser_Chrome = ( navigator.userAgent.match(/Chrome/) ? true : false );
 *    • var 20190417°0217 — bIs_Browser_Edge = ( navigator.userAgent.match(/Edge/) ? true : false );
 *    • var 20150209°0941 — bIs_Browser_Explorer
 *    • var 20160624°0121 — bIs_Browser_Firefox = ( navigator.userAgent.match(/Firefox/) ? true : false );
 *    • var 20190107°0821 — bIs_Browser_Opera = ( navigator.userAgent.match(/(Opera)|(OPR)/) ? true : false );
 *    • var 20190311°1521 — bShow_Debug_Dialogs = false;
 *    • var 20190407°0121 — bToggle_FALSE = false;
 *    • var 20190407°0122 — bToggle_TRUE;
 *    • var 20190408°0115 — bUseMinified = false;
 *    • var 20150516°0451 — InitialMessageCache = Array();
 *    • var 20160618°0421 — sFurniture_OutputArea_Id = "id20150321o0231_StandardOutputDiv";
 *    • var 20160501°1622 — s_DaftariBaseFolderAbs = '';
 *    • var 20160501°1623 — s_DaftariBaseFolderRel = '';
 *    • func 20140926°0641 — CmdlinParser = (function(){})();
 */
/**
 *  Usage. Propagate this area via cut-n-paste to the following scripts:
 *   • canvasgear.js
 *   • daftari.js
 *   • fadeinfiles.js
 *   • slidegear.js
 ...
 *
 *  Versions :
 *    • v0.2.9 — 20240428°1911 'Saveguard' [chg 20240428°1905]
 *    • v0.2.8 — 20240427°1511 — Adjust -- This was bad
 *    • v0.2.7.d — 20220312°1211 — Indent 4 spaces
 *    • v0.2.7.c — 20220307°0911 — Reformatting
 *    • 20210518°1441 — v0.2.7.b — Clear comments
 ...
 *  @return {string} —
 */
Trekta.Utils.getCookie = function(sCookieName)
{
    'use strict';
    ...
    // [condi 20201228°1331]
    // Todo 20201228°1332 : Detection is quick'n'dirty. This should be done in a more 'official' way.
    if (sCookies.length > 0) {
        ...
        for (i = 0; i < aCookies.length; i++) {
            ...
            if (sNam === sCookieName) {
                // Function unescape is deprecated, I boldly replaced it by decodeURI [chg 20190423°0641]
                sRet = decodeURI(sVal);
                break;
            }
        }
 ...
 */
Trekta.Utils.getCookieBool = function(sCookieName, bDefault)
{
    'use strict';
 ...
 */
Trekta.Utils.getCookieInt = function(sCookieName, iDefault)
{
    'use strict';
 ...
 */
Trekta.Utils.htmlEscape = function(sHtml)
{
    'use strict';
 ...
 */
Trekta.Utils.isScriptAlreadyLoaded = function (sWantedScript)
{
    'use strict';
 ...
 *  @return {undefined} —
 */
Trekta.Utils.outDbgMsg = function (sOut)
{
    'use strict';
    ...
    // '<div class="id20150321o0231_StandardOutputDiv" id="id20150321o0231_StandardOutputDiv"></div>'
    ...
    // [seq 20150321°0316]
    var eTarget = document.getElementById(Daf.Dspat.Config.sFurniture_OutputArea_Id);  // "id20150321o0231_StandardOutputDiv"
...
Trekta.Utils.outDbgMsg_GuaranteeParentElement = function ()
{
    ...
    var sTargetId = Daf.Dspat.Config.sFurniture_OutputArea_Id;          // "id20150321o0231_StandardOutputDiv"
    var ele = document.getElementById(sTargetId);                       // 'id20150321o0231_...'
    ...
    if (! ele) {
        ...
        ele = document.getElementById(sTargetId);                       // 'id20150321o0231_StandardOutputDiv'
    }
 ...
 *  @callers • Many
 *  @param {string} sScLoad — The path from page to script, e.g. "./../jsi/dafcanary.js", jsi/dafcanary.js'
 ...
 */
Trekta.Utils.pullScriptBehind = function (sScLoad, callbackOnLoad, callbackOnError, oJobs)
{
    'use strict';
    /// debugger;
 ...
 *  @return {undefined} —
 */
Trekta.Utils.pullScript_onload = function (sScript, cbkCustom)
{
    'use strict';
 ...
 *  @return  {undefined} —
 */
Trekta.Utils.readTextFile2 = function(sUrl, cbkLoad, cbkFail)
{
    'use strict';
 ...
 *
 *  @id : func 20190405°0231 [after 20140704°1011]
 ...
 *  @return {undefined} —
 */
Trekta.Utils.ajax3Send = function(sMethod, sUrl, sPayload, cbkLoad, cbkFail)
{
    'use strict';
    ...
    {
        // List after ref 20190412°0132 'MDN → XMLHttpRequest.readyState'
        if ( xmlHttp.readyState === 0 ) {
            ...
            switch (xmlHttp.status) {
                ...
                //  Is setting success to true then really a good idea?
                case   0 : break;                                       // Consider this case as fail [chg 20220221°0911]
    ...
    try {
        ...
        // Or perhaps rather just use a plain alert() .. or a popping up error box on the page?
        cbkLoad(sMsg);
    }
};
 ...
 */
Trekta.Utils.retrieveDafBaseFolderAbs = function (sScCanary)
{
    'use strict';
 ...
 *  @return {undefined} —
 */
Trekta.Utils.setCookie = function(sCookieName, sCookieValue, iExpirationDays)
{
    'use strict';
 ...
 *  @type {boolean} —
 */
Trekta.Utils.bIs_Browser_Chrome = ( navigator.userAgent.match(/Chrome/) ? true : false );
 ...
 *  @type {boolean} —
 */
Trekta.Utils.bIs_Browser_Edge = ( navigator.userAgent.match(/Edge/) ? true : false );
 ...
 *  @note Only IE11 has 'window.msCrypto'. IE11 has different user agent string than other IE [see line 20190417°0215]
 *  @type {boolean} —
 */
Trekta.Utils.bIs_Browser_Explorer = (
    ( navigator.appName.match(/Explorer/)
     || window.msCrypto                                                 // [line 20190417°0215]
      ) ? true : false
);
 ...
 *  @type {boolean} —
 */
Trekta.Utils.bIs_Browser_Firefox = ( navigator.userAgent.match(/Firefox/) ? true : false );
 ...
 *  @type {boolean} —
 */
Trekta.Utils.bIs_Browser_Opera = ( navigator.userAgent.match(/(Opera)|(OPR)/) ? true : false )
 ...
 *  @type {boolean} —
 */
Trekta.Utils.bShow_Debug_Dialogs = false;
 ...
 *  @type {boolean} —
 */
Trekta.Utils.bToggle_FALSE = false;
 ...
 *  @type {boolean} —
 */
Trekta.Utils.bToggle_TRUE = true;
 ...
 *  @type {boolean} —
 */
Trekta.Utils.bUseMinified = false;
 ...
 *  @type {Array} —
 */
Trekta.Utils.InitialMessageCache = Array();
...
Trekta.Utils.s_DaftariBaseFolderAbs = Trekta.Utils.s_DaftariBaseFolderAbs || '';  // Saveguard variable [chg 20240428°1905] This solves issue 20240428°1831 'Base folder broken'
...
Trekta.Utils.s_DaftariBaseFolderRel = Trekta.Utils.s_DaftariBaseFolderRel || '';  // Saveguard [chg 20240428°1905`02] Solve issue 20240428°1831 'Base folder broken'
...
// Starting mechanism [seq 20190106°0245]
//  Daisychain only works, if slidegear.js is loaded via script tag. If loaded
//  via pull-behind, the onload event is gone, thus call Sldgr.Func.startup()
//  manually like in Daftari func 20190417°0531 Daf.Dspat.process_slideshow.
